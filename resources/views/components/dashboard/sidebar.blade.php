<aside class="hidden min-h-screen border-r border-emerald-950/10 bg-[#f3f6f0] px-5 py-6 lg:block">
    ...
    <div class="mt-8 border-t border-emerald-950/10 pt-8">
        ...
        <nav class="mt-3 space-y-2 text-sm font-bold text-stone-700" aria-label="Support navigation">
            <a href="mailto:support@mydualist.com" class="flex items-center gap-3 rounded-2xl px-4 py-3 transition hover:bg-white hover:text-emerald-950">Help & Support</a>
            <a href="mailto:support@mydualist.com" class="flex items-center gap-3 rounded-2xl px-4 py-3 transition hover:bg-white hover:text-emerald-950">Contact Us</a>
        </nav>
    </div>

    <div class="mt-10 rounded-3xl bg-emerald-900 p-5 text-white shadow-xl shadow-emerald-950/10">
        <p class="text-base font-extrabold">Upgrade to Pro</p>
