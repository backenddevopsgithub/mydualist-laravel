<div class="mx-auto grid max-w-7xl gap-2 text-sm font-bold text-stone-700">
    ...
    <a href="{{ route('dashboard.archived') }}" class="rounded-xl px-3 py-3 hover:bg-emerald-50">Archived Lists</a>
    ...
    <a href="mailto:support@mydualist.com" class="rounded-xl px-3 py-3 hover:bg-emerald-50">Help & Support</a>
</div>
