...
>
    <div class="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-6 lg:px-8">
        ...
        <nav class="hidden items-center gap-8 text-sm font-bold text-stone-600 lg:flex" aria-label="Main navigation">
            <a href="{{ route('home') }}#how-it-works" class="transition hover:text-emerald-800">How it works</a>
            <a href="{{ route('blogs.index') }}" @class(['text-emerald-800' => request()->routeIs('blogs.*'), 'transition hover:text-emerald-800' => ! request()->routeIs('blogs.*')])>Dua Resources</a>
        </nav>
        ...
        <div class="hidden items-center gap-3 lg:flex">
            ...
            @else
                ...
                <a href="{{ route('onboarding.start') }}" class="rounded-full border-2 border-emerald-800 px-5 py-2 text-sm font-bold text-emerald-800 transition hover:bg-emerald-50">
                    Create a Dua List
                </a>
